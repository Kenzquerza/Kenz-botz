...
/////////////////
const BotName = 'KENZ BOT☄'; 
const instagram = 'https://instagram.com/kenzquerza'; 

const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = ' 'https://youtu.be/-KdhGSQqloY
//const grupch1 = 'belum ada grup'; https://chat.whatsapp.com/LEFxHFRviLB9D8mDPbQN66
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@kenzquerza')
